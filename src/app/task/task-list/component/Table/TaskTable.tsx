      ...
      setData([
        {
          ...
          "description": "Finish the quarterly financial report and submit to management.",
          "date": "2025-02-01",
          "priority_level": "High",
        ...
        },
        {
          ...
          "description": "Prepare slides and documentation for the upcoming client presentation.",
          "date": "2025-01-28",
          "priority_level": "High",
          "comments": "Ensure all client concerns are addressed in the presentation."
        },
        {
          "task_title": "Fix Website Bugs",
          "description": "Identify and resolve bugs reported by users on the website.",
          "date": "2025-01-25",
          "priority_level": "High",
        ...
        },
        {
          ...
          "description": "Conduct training session for the team on the new project management tool.",
          "date": "2025-02-03",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "date": "2025-02-10",
          "priority_level": "High",
          "comments": "Coordinate with the marketing team to ensure all assets are ready."
        },
        {
          "task_title": "Write Product Blog Post",
          "description": "Write and publish a blog post highlighting the new product features.",
          "date": "2025-02-15",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Evaluate the performance reports of all employees for the last quarter.",
          "date": "2025-01-30",
          "priority_level": "High",
        ...
        },
        {
          ...
          "description": "Coordinate the logistics and activities for the company picnic.",
          "date": "2025-03-05",
          "priority_level": "Low",
        ...
        },
        {
          ...
          "description": "Ensure all software licenses are renewed before expiration.",
          "date": "2025-01-29",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Perform an audit of the company's expenses for the last quarter.",
          "date": "2025-02-12",
          "priority_level": "High",
          "comments": "Coordinate with the finance department for required documents."
        },
        {
        ...
        },
        {
          ...
          "description": "Update social media profiles with the latest company achievements.",
          "date": "2025-01-26",
          "priority_level": "Low",
        ...
        },
        {
          ...
          "description": "Organize an interactive team-building activity for the department.",
          "date": "2025-03-02",
          "priority_level": "Low",
        ...
        },
        {
          ...
          "description": "Prepare the budget proposal for the upcoming fiscal year.",
          "date": "2025-02-25",
          "priority_level": "High",
          "comments": "Consult with the finance department for accurate estimates."
        },
        {
        ...
        },
        {
          ...
          "description": "Prepare all necessary documents for the upcoming company audit.",
          "date": "2025-02-18",
          "priority_level": "High",
        ...
        },
        {
          ...
          "description": "Finalize the new employee benefits package for approval.",
          "date": "2025-02-22",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Update the project roadmap with current timelines and deliverables.",
          "date": "2025-01-27",
          "priority_level": "Medium",
          "comments": "Review with the project management team before finalizing."
        },
        {
          "task_title": "Develop Marketing Strategy for Q2",
          "description": "Create a marketing strategy for the second quarter of the year.",
          "date": "2025-02-07",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Conduct a training session for the customer support team on new tools.",
          "date": "2025-02-13",
          "priority_level": "Low",
          "comments": "Ensure all team members are familiar with the new platform."
        },
        {
          "task_title": "Redesign Company Logo",
          "description": "Work with the design team to refresh the company logo for the rebrand.",
          "date": "2025-03-01",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Ensure all security protocols are up to date across company systems.",
          "date": "2025-02-06",
          "priority_level": "High",
        ...
        },
        {
          ...
          "description": "Meet with the sales team to discuss strategy for the upcoming quarter.",
          "date": "2025-02-14",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Deploy the latest software update to all company devices.",
          "date": "2025-01-24",
          "priority_level": "High",
        ...
        },
        {
          ...
          "description": "Design and distribute an employee satisfaction survey to gather feedback.",
          "date": "2025-02-02",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Update and redesign the employee handbook with new policies.",
          "date": "2025-02-17",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Update the customer relationship management (CRM) system with the latest data.",
          "date": "2025-02-04",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Upgrade the company's network infrastructure to improve speed and security.",
          "date": "2025-02-11",
          "priority_level": "High",
          "comments": "Coordinate downtime with the IT team to minimize disruptions."
        },
        {
          "task_title": "Create Client Proposal",
          "description": "Draft and send a proposal to the potential client for their project.",
          "date": "2025-02-16",
          "priority_level": "Medium",
        ...
        },
        {
          ...
          "description": "Negotiate terms with vendors for upcoming project supply needs.",
          "date": "2025-03-03",
          "priority_level": "Medium",
        ...
        <div className="h-64 flex items-center justify-center">
          <div className="w-full animate-pulse space-y-4">
            {[...Array(5)].map((_, idx) => (
              <div
                key={idx}
                className="h-4 bg-gray-400 dark:bg-gray-600 rounded-lg"
              ></div>
            ))}
          </div>
        </div>
